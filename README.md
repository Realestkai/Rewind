...
Rewind is now a Discord ticket bot for RYVN vehicle support, vehicle sales, and custom commissions. There is no website or dashboard.
...
2. A member selects **Open a request** and specifies whether they need vehicle support, purchase help, or a commission; the relevant vehicle/build; full details; and, optionally, an order/invoice ID or Roblox username.
